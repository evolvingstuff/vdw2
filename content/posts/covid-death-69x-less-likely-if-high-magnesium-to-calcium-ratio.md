{
    "title": "COVID death 6.9X less likely if high Magnesium to Calcium ratio",
...
<img src="https://d1bk1kqxc0sym.cloudfront.net/attachments/jpeg/covid-mgca.jpg" alt="image" width="500">

This is a subset of the PDF table
...
* 3.93 (95%CI 1.6–9.3) in women. 
   ...
   * ''<span style="color:#00F;">Suspect a mistake was made: Have not seen an average to be greater thanthe items being averaged'</span>'
 ...
 **<i class="fas fa-file-pdf" style="margin-right: 0.3em;"></i><a href="https://d1bk1kqxc0sym.cloudfront.net/attachments/pdf/mgca-ratio-and-covid.pdf">Download the PDF from VitaminDWiki </a>**
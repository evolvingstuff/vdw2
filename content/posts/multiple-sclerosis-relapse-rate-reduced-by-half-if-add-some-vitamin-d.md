{
    "title": "Multiple Sclerosis relapse rate reduced by half if add some vitamin D",
    "slug": "multiple-sclerosis-relapse-rate-reduced-by-half-if-add-some-vitamin-d",
    "aliases": [
...
Brain Behav. 2017 Jul 11;7(8):e00761. [doi: 10.1002/brb3.761.](https://doi.org/10.1002/brb3.761.) eCollection 2017 Aug.

Miclea A1,2, Miclea M1, Pistor M2, Hoepner A3, Chan A4, Hoepner R4.

 **<i class="fas fa-file-pdf" style="margin-right: 0.3em;"></i><a href="https://d378j1rmrlek7x.cloudfront.net/attachments/pdf/vitamin-d-supplementation-differentially-affects-seasonal-multiple-sclerosis.pdf">Download the PDF from VitaminDWiki</a>** 

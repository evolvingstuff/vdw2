{
  "title": "Less Head and Neck Cancer if higher Vitamin D - 30% less risk, fewer problems",
  "slug": "less-head-and-neck-cancer-if-higher-vitamin-d-30-percent-less-risk-fewer-problems",
  "aliases": [
 ...
 **<i class="fas fa-file-pdf" style="margin-right: 0.3em;"></i><a href="https://d1bk1kqxc0sym.cloudfront.net/attachments/pdf/head-and-neck-cancer.pdf">Download the PDF from VitaminDWiki </a>** 

---

#### See also: <a href="/posts/head-and-neck-cancers-and-vitamin-d-many-studies" style="color: red; text-decoration: underline;" title="This post/category does not exist yet: Head and neck cancers and vitamin D - many studies">Head and neck cancers and vitamin D - many studies</a>

<!-- ~tc~ (alias(Head and Neck Cancers and increased Vitamin D - 30%  less risk, far fewer problems - March 2025)) ~/tc~ -->

<!-- ~tc~ (alias(Less Head and Neck Cancers if higher Vitamin D - 30% less risk, fewer problems - March 2025)) ~/tc~ -->
{
    "title": "Vitamin D and RCTs (Randomized Controlled Trials)",
    "slug": "vitamin-d-and-rcts-randomized-controlled-trials",
    "aliases": [
...
* [WikiPedia](https://en.wikipedia.org/wiki/Randomized_controlled_trial#Relative_importance_and_observational_studies) " RCTs may be unnecessary for treatments that have dramatic and rapid effects relative to the expected stable or progressively worse natural course of the condition treated."
 ...
 **[Publisher wants $36 for the PDF](http://www.sciencedirect.com/science/article/pii/S0960076017301280%20)** 
...
Trials. 2016 Jul 29;17:374. [doi: 10.1186/s13063-016-1451-9.](https://doi.org/10.1186/s13063-016-1451-9.)
...
Overall, 314/2573 (12 %) participants failed run-in; 211 (67 %) took fewer than 80 % of their tablets (poor adherence), and 103 (33 %) withdrew or were uncooperative. In multivariable models, 8- to 13-fold variation was seen by study center in odds of RIF risk in the two largest groups. In men, RIF decreased with age (adjusted odds ratio <span>[OR]</span> per 5 years 0.85 <span>[95 % confidence interval, CI; 0.76-0.96]</span>) and was associated with being single (OR 1.65 <span>[95 % CI; 1.10-2.47]</span>), not graduating from high school (OR 2.77 <span>[95 % CI; 1.58-4.85]</span>), and missing SAQ data (OR 1.97 <span>[1.40-2.76]</span>). Among women, RIF was associated primarily with health-related factors; RIF risk was lower with higher physical health score (OR 0.73 <span>[95 % CI; 0.62-0.86]</span>) and baseline multivitamin use (OR 0.44 <span>[95 % CI; 0.26-0.75]</span>). Women in the 5-year colonoscopy surveillance interval were at greater risk of RIF than those with 3-year follow-up (OR 1.91 <span>[95 % CI; 1.08-3.37]</span>), and the number of prescription medicines taken was also positively correlated with RIF (p = 0.03). 
 ...
 **<i class="fas fa-file-pdf" style="margin-right: 0.3em;"></i><a href="https://d1bk1kqxc0sym.cloudfront.net/attachments/pdf/randomized-controlled-trials---who-fails-run-in.pdf">Download the PDF from VitaminDWiki</a>** 

---

#### 32% of Breast Cancer patients in an RCT failed to consistent take DAILY vitamin D - July 2016

* [Impact of a tailored oral vitamin D supplementation regimen on serum 25-hydroxyvitamin D levels in early breast cancer patients: a randomized phase III study](https://academic.oup.com/annonc/article/27/7/1235/1741209/Impact-of-a-tailored-oral-vitamin-D)
...
* [Vitamin D – wait for Random Controlled Trials, rebuttal – not wait and consider UV – Feb 2015](/posts/vitamin-d-wait-for-random-controlled-trials-rebuttal-not-wait-and-consider-uv)
 ...
 **<span style="color:#00F;">Excellent </span>** 

 **<i class="fas fa-file-pdf" style="margin-right: 0.3em;"></i><a href="https://d1bk1kqxc0sym.cloudfront.net/attachments/pdf/how-to-understand-refute-and-plan-studies-using-vitamin-d-min.pdf">Download the PDF from VitaminDWiki</a>** 
...
* [Muscle strength not increased by Vitamin D - 96 percent were not deficient – RCT April 2017](/posts/muscle-strength-not-increased-by-vitamin-d-96-percent-were-not-deficient-rct)

* [Why 100,000 IU of vitamin D monthly did not reduce Cardiovascular Disease – RCT April 2017](/posts/why-100000-iu-of-vitamin-d-monthly-did-not-reduce-cardiovascular-disease-rct)
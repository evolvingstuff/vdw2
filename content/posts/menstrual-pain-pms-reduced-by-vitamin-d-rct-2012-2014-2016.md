{
    "title": "Menstrual Pain (PMS) reduced by vitamin D \u2013 RCT 2012, 2014, 2016",
    "slug": "menstrual-pain-pms-reduced-by-vitamin-d-rct-2012-2014-2016",
    "aliases": [
...
* [Vitamin D and PTH Status among Adolescent and Young Females with Severe Dysmenorrhea.](http://www.ncbi.nlm.nih.gov/pubmed/24405636?dopt=Abstract) Jan 2014

> (80%) had insufficient plasma vitamin D

* Serum vitamin D concentrations in young Turkish women with primary dysmenorrhea: A randomized controlled study - 2018

>  **<i class="fas fa-file-pdf" style="margin-right: 0.3em;"></i><a href="https://d1bk1kqxc0sym.cloudfront.net/attachments/pdf/dysmenorrhea-2018.pdf">Download the PDF from VitaminDWiki</a>** 

<img src="https://d1bk1kqxc0sym.cloudfront.net/attachments/jpeg/dysmenorrhea-other.jpg" alt="image" width="500">

---

#### 25,000 IU of Vitamin D every 2 weeks reduced PMS - RCT  Aug 2016

 **[Vitamin D Supplementation for Premenstrual Syndrome-Related Mood Disorders in Adolescents with Severe Hypovitaminosis D](https://www.ncbi.nlm.nih.gov/pubmed/26724745)** 

Startred with a loading dose of 200,000 IU

J Pediatr Adolesc Gynecol. 2016 Aug;29(4):357-61. [doi: 10.1016/j.jpag.2015.12.00](https://doi.org/10.1016/j.jpag.2015.12.00)
...
Women were randomized into 2 groups: 20 women received a single oral dose of cholecalciferol (300 000 IU/1 mL <span>[Abiogen Pharma S.P.A.]</span>) 5 days before the putative beginning of their next menstrual cycle, while another 20 women received placebo.
...
Figure. Changes in mean (SD) pain score in the placebo-treated (A) and vitamin D–treated (B) groups over the 60 days of the study. Eligible women reported intensity of pain on a visual analog scale (VAS) at baseline and then at the end of the first and second month after the dose of placebo or vitamin D. The filled circles in the right panels represent individual changes. Both placebo and vitamin D groups were homogeneous for age (mean <span>[SD]</span>, 27 <span>[6.01]</span> y vs 26.3 <span>[6.23]</span> y), body mass index (mean <span>[SD]</span>, 21.17 <span>[2.15]</span> vs 21.96 <span>[2.06]</span> <span>[calculated as weight in kilograms divided by height in meters squared]</span>), baseline 25-hydroxyvitamin D3 levels (mean <span>[SD]</span>, 29.97 <span>[7.62]</span> ng/mL vs 27.19 <span>[7.53]</span> ng/mL <span>[to convert to nanomoles per liter, multiply by 2.496]</span>), and baseline VAS pain score (mean <span>[SD]</span>, 5.60 <span>[1.90]</span> vs 5.85 <span>[2.00]</span>).

Calcitriol (1,25<span>[OH]</span>2D) decreases, in vitro, the level of proinflammatory cytokines such as interleukin 6 and tumor necrosis factor 5 and regulates the expression of several key genes involved in the PG pathway causing decreased biological activity of PGs.6
 ...
 **<i class="fas fa-file-pdf" style="margin-right: 0.3em;"></i><a href="https://d1bk1kqxc0sym.cloudfront.net/attachments/pdf/ilt120001-366-367.pdf">Download the study with graphics from VitaminDWiki</a>** 

{
    "title": "Nanoparticles could be used to increase vitamin D getting to the gut",
    "slug": "nanoparticles-could-be-used-to-increase-vitamin-d-getting-to-the-gut",
    "aliases": [
...
Food and Bioproducts Processing, Volume 96, October 2015, Pages 264–277, doi:10.1016/j.fbp.2015.09.007

Elham Hasanvanda, Milad Fathib, , , Alireza Bassiric, Majid Javanmarda, Rouzbeh Abbaszadeha

 **Highlights** 

• Novel high amylose starch based nanoparticles were developed for entrapment of Vitamin D3.

• Release of encapsulant can be postponed in gastric media.

• Vitamin loaded nanocarriers can be used to produce functional food.
 ...
 **<i class="fas fa-file-pdf" style="margin-right: 0.3em;"></i><a href="https://d378j1rmrlek7x.cloudfront.net/attachments/pdf/nano-in-starch-sci-hub.pdf">Download the PDF from sci-hub via VitaminDWiki</a>** 

---

 **Note: Bio-Tech Pharmacal has a water-soulable form of vitamin D which can be added to milk, food, etc.** 

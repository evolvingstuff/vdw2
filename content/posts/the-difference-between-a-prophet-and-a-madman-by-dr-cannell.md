{
    "title": "The difference between a prophet and a madman \u2013 by Dr. Cannell",
    "slug": "the-difference-between-a-prophet-and-a-madman-by-dr-cannell",
    "aliases": [
        "/The+difference+between+a+prophet+and+a+madman+\u2013+by+Dr+Cannell+Nov+2011",
        "/2227"
    ],
    "tiki_page_id": 2227,
    "date": "2011-12-08",
...
Br J Nutr. 2011 Nov;106(9):1317-8. Epub 2011 Jun 7.

Cannell JJ.

Vitamin D Council, 1241 Johnson Avenue, CA, USA. jjcannell@vitamindcouncil.org

Which is a comment on    Br J Nutr. 2011 Nov;106(9):1433-40. <a href="/posts/click-here-at-vitamindwiki" style="color: red; text-decoration: underline;" title="This link has an unknown page_id: 1811">CLICK HERE at VitaminDWiki</a>

The following was copied from  **<span style="color:#00F;">Facebook </span>** -  **bolding**  emphasis by VitaminDWiki

I realize that when I write for a journal that most of my readers cannot access my writing. This month the British Journal of Nutrition invited me to write an article; it is below. To put the article into context, my long-time readers will remember the excitement back in 2005 when I discovered that vitamin D appeared to prevent influenza.
...
Finally, to be sure, the study by Berry et al. speaks only of the respiratory system, yet antimicrobial effects of vitamin D may be more generalized. Recently, researchers in Tennessee wanted to know if vitamin D levels were associated with overall mortality in the intensive care unit (ICU). They found patients were almost twice as likely to die during an ICU stay if they had vitamin D deficiency (<20 ng/ml). (<a href="/posts/00fat-vitamindwiki" style="color: red; text-decoration: underline;" title="This link has an unknown page_id: 1428">~~#00F:at VitaminDWiki</a>~~)

Respiratory infections are but one failure of the immune system that lead children into the ICU. Meningitis is another, a grim wintertime scythe that should be treated not only with conventional antimicrobials, but also (in my opinion) with pharmacological doses of vitamin D (10,000 IU/10 kg per day for several days). 

And, should any promising observer note an association between meningitis and a ‘seasonal stimulus’, and then suffer the scorn of their colleagues, remember Dr. Edgar Hope-Simpson and remember also that  **time alone distinguishes a prophet from a madman** .

Dr. Cannell is founder and principal of the educational organization, the Vitamin D Council. 

In addition, he receives royalties from Purity Products on the sale of his ‘Advanced Vitamin D Formula’

- - - - - - - - 

# See also VitaminDWiki

* <a href="/posts/how-to-reduce-probability-of-getting-the-flu" style="color: red; text-decoration: underline;" title="This link has an unknown page_id: 2211">How to reduce probability of getting the Flu</a> with Vitamin D
...
* <a href="/posts/reduced-viral-respiratory-track-infections-by-half-by-having-more-than-38-ng-of-vitamin-d" style="color: red; text-decoration: underline;" title="This link has an unknown page_id: 331">Reduced viral respiratory track infections by half by having more than 38 ng of vitamin D – June 2010</a>

* [Overview Asthma and Vitamin D](/posts/overview-asthma-and-vitamin-d)

* [All items in Immunity and Vitamin D](https://www.VitaminDWiki.com/tiki-browse_categories.php?parentId=35&sort_mode=created_desc) 52 items as of Dec 2011

* <a href="/posts/introduction-to-vitamin-d-council-at-vitamindwiki" style="color: red; text-decoration: underline;" title="This link has an unknown page_id: 112">Introduction to Vitamin D Council at VitaminDWiki</a>
...
* <a href="/posts/immune-system-and-vitamin-d-patent" style="color: red; text-decoration: underline;" title="This link has an unknown page_id: 1792">Immune system and vitamin D patent</a> 2008

> Following graph shows that 10,000 IU per 10kg = 1,000 IU per 1 kg o= 91,000 IU per 200 lb person is at the low range

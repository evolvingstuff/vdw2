{
    "title": "Clinical Trials of vitamin D can have \u201cbiological flaws\u201d",
    "slug": "clinical-trials-of-vitamin-d-can-have-biological-flaws",
    "aliases": [
...
### [Vitamin D for treatment of depression](http://www.vitamindcouncil.org/blog/vitamin-d-for-treatment-of-depression/#) Vitamin D Council
...
1. Interventions producing the opposite effect of that intended 

> &nbsp; &nbsp; &nbsp;(interventions that included Vitamin D, but reduced the 25OHD level in the intervention group).

1. Ineffective interventions that did not improve vitamin D status (did not significantly change the 25OHD level).

1. Where the baseline 25OHD level was not measured in the majority of participants.

1. Where the baseline 25OHD level indicated sufficiency (not deficiency) at baseline.

1. RCT must include subjects with the condition being studied (i.e. Depression)
 ...
 **[Summary of Depression and Vitamin D](http://www.vitamindcouncil.org/health-conditions/depression/) Vitamin D Council**   updated 2012
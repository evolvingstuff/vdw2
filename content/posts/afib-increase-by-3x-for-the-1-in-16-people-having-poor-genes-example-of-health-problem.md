{
    "title": "Afib increase by 3X for the 1 in 16 people having poor genes (example of health problem)",
...
* [Why Do Polygenic Risk Scores Get So Much Hype?](https://www.genengnews.com/gen-exclusives/why-do-polygenic-risk-scores-get-so-much-hype/77901139) Aug 2018  reporting on the study on this page
...
> Has a link to a [web application](https://mygenerank.scripps.edu/?_ga=2.63124143.1453084840.1539556389-1820599033.1539556389) which uses  **23andme**  data to assess risk based on both Polygenic Score and Lifestyle - see following image

> <img src="https://d378j1rmrlek7x.cloudfront.net/attachments/jpeg/gene-risk.jpg" alt="image" width="400">

</div>

 **<i class="fas fa-file-pdf" style="margin-right: 0.3em;"></i><a href="https://d378j1rmrlek7x.cloudfront.net/attachments/pdf/genome-wide-polygenic-scores.pdf">Download the PDF from VitaminDWiki</a>** 

<img src="https://d378j1rmrlek7x.cloudfront.net/attachments/jpeg/polygenetic-afib.jpg" alt="image" width="400">
...
<!-- ~tc~ (alias(Afib can increase by 3X for 1 in 12 people if poor genes (example of health problem) – Aug 2018)) ~/tc~ -->

<!-- ~tc~ (alias(Afib increase by 3X for the 1 in 12 people having poor genes (example of health problem) – Aug 2018)) ~/tc~ -->
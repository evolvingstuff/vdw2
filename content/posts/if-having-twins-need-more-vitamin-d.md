{
    "title": "If having twins, need more vitamin D",
    "slug": "if-having-twins-need-more-vitamin-d",
    "aliases": [
...
#### Maternal and neonatal vitamin-D status in twin versus singleton pregnancies - June 2016
...
| | | | |
| --- | --- | --- | --- |
|  | twins | single | % deficient<br>(< 8 ng) |
...
* [Maternal 25-Hydroxyvitamin D and Preterm Birth in Twin Gestations](http://www.ncbi.nlm.nih.gov/pmc/articles/PMC3706065/)
...
* [Preterm birth 30 percent more likely if low vitamin D – meta-analysis May 2016](/posts/preterm-birth-30-percent-more-likely-if-low-vitamin-d-meta-analysis)
...
Subjects included 50 women with twin pregnancy delivering at >28 weeks and 50 gestational-age-matched women with singleton pregnancy delivering during the same period. Maternal and neonatal serum 25-hydroxy vitamin D <span>[25(OH)D]</span> was compared between the two groups using the independent Student's t-test on log values. Serum albumin-adjusted calcium, inorganic phosphate, and intact parathormone levels were also compared.
 ...
 **[Publisher rents PDF for $6](http://onlinelibrary.wiley.com/doi/10.1111/jog.13060/abstract)** 

---

#### Twins and mothers have lower Vitamin D Levels - 2016

 **Maternal and neonatal vitamin-D status in twin versus singleton pregnancies** 

J Obstet Gynaecol Res. 2016 Oct;42(10):1250-1257. [doi: 10.1111/jog.13060](https://doi.org/10.1111/jog.13060)

Deepti Goswami 1, Reena Rani 2, Alpana Saxena 3, Monika Sethi Arora 4, Swaraj Batra 2, Vishnubhatla Sreenivas 5
...
Results: Maternal vitamin-D deficiency (VDD; serum 25(OH)D < 30 nmol/L) was present in 90% of twin and 88% of singleton pregnancies. 

The prevalence of neonatal VDD was 89% in twin and 74% in singleton pregnancies (P = 0.03). 

Maternal serum 25(OH)D was lower in the twin group as compared to the singleton group ( **14.3**  ± 10.47 vs  **18.5**  ± 12.36 nmol/L; P = 0.02). Mean serum calcium, intact parathormone, and inorganic phosphate were comparable between the women in the two groups. Maternal and neonatal 25(OH)D showed positive correlation in the two groups (P < 0.001). 
...
#### Vitamin D and Twins - April 2021

 **Vitamin D status in women with dichorionic twin pregnancies and their neonates: a pilot study in China** 

 **<i class="fas fa-file-pdf" style="margin-right: 0.3em;"></i><a href="https://d378j1rmrlek7x.cloudfront.net/attachments/pdf/vit-d-and-twins.pdf">Download the PDF from VitaminDWiki</a>** 

<img src="https://d378j1rmrlek7x.cloudfront.net/attachments/jpeg/twins-2021.jpg" alt="image" width="600">

<!-- ~tc~ (alias(If having twins, need more vitamin D – June 2016)) ~/tc~ -->
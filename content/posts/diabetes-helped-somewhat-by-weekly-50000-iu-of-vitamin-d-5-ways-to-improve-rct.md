{
    "title": "Diabetes helped somewhat by weekly 50,000 IU of vitamin D (5 ways to improve) \u2013 RCT",
...
1. Use a gut-friendly form of vitamin D

   * also - topical forms do not need the gut

1. Start by first restoring vitamin D levels

   * with larger doses for those who have low levels of vitamin D

1. Include co-factors needed by individuals– such as Magnesium

1. Include Vitamin D Receptor activators - to get the Vitamin D to the cells, not just the blood
 ...
 **<i class="fas fa-file-pdf" style="margin-right: 0.3em;"></i><a href="https://d378j1rmrlek7x.cloudfront.net/attachments/pdf/diabetes-50-000-iu-weekly-helped-compressed.pdf">Download the PDF from VitaminDWiki</a>** 
...
<!-- ~tc~ (alias(Diabetes helped somewhat by weekly 50,000 IU of vitamin D (4 ways to improve it) – Aug 2021)) ~/tc~ -->

<!-- ~tc~ (alias(Diabetes helped somewhat by weekly 50,000 IU of vitamin D (5 ways to improve) – Aug 2021)) ~/tc~ -->
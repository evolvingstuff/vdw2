...
#### PFOA, PFASS may also reduce activation of VDR and other genes
 ...
 **[<i class="fas fa-file-pdf" style="margin-right: 0.3em;"></i>Download the pre-print PDF from VitaminDWiki ](/attachments/d3.mock.pdf)** 
...
<!-- ~tc~ (alias(PFAS (chemicals in food packaging, carpets, etc) reduce Vitamin D levels)) ~/tc~ -->

<!-- ~tc~ (alias(PFAS (forever chemicals) reduce Vitamin D, cause health problems (many studies)) ~/tc~ -->

{
    "title": "Magnesium reference ranges \u2013 43 now, suggest a low of 0.85 nmol (2.07 mg)",
...
<img src="https://d378j1rmrlek7x.cloudfront.net/attachments/jpeg/mg-reference-ranges.jpg" alt="image" width="500">
 ...
 **<i class="fas fa-file-pdf" style="margin-right: 0.3em;"></i><a href="https://d378j1rmrlek7x.cloudfront.net/attachments/pdf/mg-reference-range.pdf">Download the PDF from VitaminDWiki </a>** 

---

#### Magnesium interacts with Calcium and Vitamin D - VitaminDWiki suspects can not look at them in isolation

---

#### See also VitaminDWiki

* [Magnesium deficiency level should be raised from .75 to .85 – April 2021](/posts/magnesium-deficiency-level-should-be-raised-from-75-to-85)
...
* [Magnesium in Healthcare (Rickets, Stones, Pregnancy, Depression, etc.) with level of evidence – Sept 2017](/posts/magnesium-in-healthcare-rickets-stones-pregnancy-depression-etc-with-level-of-evidence)
   ...
   * concluded that need more than 0.85

* [Four Magnesium Deficiency Questionnaires for women - July 2020](/posts/four-magnesium-deficiency-questionnaires-for-women)

* [Magnesium tests](/posts/magnesium-tests) both serum (this sudy) and more accurate but expensive Ionized

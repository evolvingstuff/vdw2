---
title: "Vitamin D every 14 weeks is not often enough (asthma in this case)"
 ...
 **Infrequent dosing was not associated with Asthma  reduction** 
...
* <a href="/posts/graph-of-weekly-response-to-monthly-vitamin-d-supplementation" style="color: red; text-decoration: underline;" title="This post/category does not exist yet: Graph of weekly response to monthly vitamin D supplementation – Aug 2015">Graph of weekly response to monthly vitamin D supplementation – Aug 2015</a> 
   ...
   * shows that montly dosing is OK
...
Children (N = 47) were randomised (intervention, 23; control, 24) in the fall. There was a significant adjusted group difference in the Δ25OHD (95% confidence interval) of 57.8 (47.3, 68.4) nmol/L, p < 0.0001), with a time (p < 0.0001) and group*time interaction effect (p < 0.0001), in favour of the intervention. A significant group difference in the Δ25OHD was observed 10 days after the first (119.3 <span>[105.8, 132.9]</span> nmol/L) and second (100.1 <span>[85.7, 114.6]</span> nmol/L) bolus; it did not reach statistical significance at 3.5 and 7 months. At 3.5 and 7 months, respectively, 63% and 56% of the intervention group were vitamin D sufficient (≥ 75 nmol/L) compared to 39% and 36% of the control group. Hypercalciuria, all without hypercalcaemia, was observed in 8.7% of intervention and 10.3% of control samples at any time point. Exacerbations requiring rescue oral corticosteroids, which appear as a promising primary outcome, occurred at a rate of 0.87/child.

{
    "title": "Vitamin D and infectious diseases like RTI, TB and Sepsis",
    "slug": "vitamin-d-and-infectious-diseases-like-rti-tb-and-sepsis",
    "aliases": [
 ...
 **<i class="fas fa-file-pdf" style="margin-right: 0.3em;"></i><a href="https://d378j1rmrlek7x.cloudfront.net/attachments/pdf/infectious.pdf">Download the PDF from VitaminDWiki.</a>**
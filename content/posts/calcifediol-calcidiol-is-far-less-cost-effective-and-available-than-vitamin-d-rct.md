{
    "title": "Calcifediol (Calcidiol) is far less cost-effective and available than Vitamin D \u2013 RCT",
...
J Bone Miner Res. 2021 Jun 8. [doi: 10.1002/jbmr.4387](https://doi.org/10.1002/jbmr.4387)
...
<img src="https://d1bk1kqxc0sym.cloudfront.net/attachments/jpeg/calcif.jpg" alt="image" width="600">
...
1. Calcidiol costs about 70X more per IU than vitamin D

1. Calcidiol requires a prescription, whereas normal vitamin D is over-the counter

1. Have been unable to get independant confirmation that Calcidiol has a fast response time

1. There is vastly more information for Vitamin D concerning

   * loading doses, co-factors, time between doses, etc.

1. This study was written by the company making it

* [Vitamin D trial for COVID-19 – using their patented slow-release form – Aug 2021](/posts/vitamin-d-trial-for-covid-19-using-their-patented-slow-release-form)

</div>

 **<i class="fas fa-file-pdf" style="margin-right: 0.3em;"></i><a href="https://d1bk1kqxc0sym.cloudfront.net/attachments/pdf/calcifediol-is-superior-to-cholecalciferol.pdf">Download the PDF from VitaminDWiki</a>** 
...
<!-- ~tc~ (alias(Calcifediol (Calcidiol )is far less cost-effective and available than Vitamin D – RCT June 2021)) ~/tc~ -->
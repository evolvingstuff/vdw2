{
    "title": "Multiple Sclerosis much more likely if poor Vitamin D Receptor \u2013 several studies",
    "slug": "multiple-sclerosis-much-more-likely-if-poor-vitamin-d-receptor-several-studies",
    "aliases": [
 ...
 **<i class="fas fa-file-pdf" style="margin-right: 0.3em;"></i><a href="https://d378j1rmrlek7x.cloudfront.net/attachments/pdf/ms-vdr-meta.pdf">Download the PDF from Sci-Hub via VitaminDWiki</a>** 

<!-- ~tc~ (alias(Multiple Sclerosis about 3 times more likely if Vitamin D Receptor problems – Aug 2016)) ~/tc~ -->
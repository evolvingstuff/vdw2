---
title: "The COVID Virus May Prompt the Body to Attack Itself"
...
#### Copied from [WebMD](https://www.webmd.com/lung/news/20210129/covid-virus-may-prompt-body-to-attack-itself)
...
WebMD's Chief Medical Officer, John Whyte, MD, speaks with Ashish K. Jha, MD, Dean, School of Public Health, Brown University, about immediate actions needed to confront the COVID-19 mutations.

The [study](https://www.medrxiv.org/content/10.1101/2021.01.27.21250559v1), which has not yet been peer reviewed, also deepens the question of whether other respiratory viruses might also break the body’s tolerance to itself, setting people up for [autoimmune diseases](https://www.webmd.com/a-to-z-guides/autoimmune-diseases) like [multiple sclerosis](https://www.webmd.com/multiple-sclerosis/default.htm), [rheumatoid arthritis](https://www.webmd.com/rheumatoid-arthritis/default.htm), and lupus later in life.

Utz says he and his team are next going to study [flu](https://www.webmd.com/cold-and-flu/default.htm) patients to see if that virus might also cause this phenomenon.

“My prediction is that it isn’t going to be specific just to [SARS](https://www.webmd.com/lung/lung-what-is-sars)-CoV-2. I’m willing to bet that we will find this with other respiratory viruses,” he says.

The study comes on the heels of a handful of [smaller, detailed investigations](https://www.medrxiv.org/content/10.1101/2021.01.21.21249176v1) that have come to similar conclusions.
...
Researchers used blood tests to study their immune responses as their infections progressed. Researchers looked for autoantibodies - weapons of the [immune system](https://www.webmd.com/cold-and-flu/immune-system-function) that go rogue and launch an attack against the body’s own tissues. They compared these autoantibodies to those found in people who were not infected with the virus that causes COVID.
...
But in others, about 20% of people who had them, the autoantibodies became more common as the infection progressed, suggesting they were directly related to the [viral infection](https://www.webmd.com/a-to-z-guides/bacterial-and-viral-infections), instead of being a [preexisting condition](https://www.webmd.com/health-insurance/getting-insurance-when-you-have-health-problem).

Some of these were antibodies that attack key components of the immune system’s weapons against the virus, like interferon. Interferons are proteins that help infected cells call for reinforcements and can also interfere with a virus’s ability to copy itself. Taking them out is a powerful evasive tactic, and [previous studies](https://science.sciencemag.org/content/370/6515/eabd4585) have shown that people who are born with genes that cause them to have lower interferon function, or who make autoantibodies against these proteins, appear to be at higher risk for life-threatening COVID infections.
...
Utz says they started the study after seeing COVID patients with strange collections of symptoms that looked more like autoimmune diseases than viral infections - [skin rashes](https://www.webmd.com/skin-problems-and-treatments/guide/common-rashes), [joint pain](https://www.webmd.com/pain-management/guide/joint-pain), fatigue, aching muscles, [brain swelling](https://www.webmd.com/brain/brain-swelling-brain-edema-intracranial-pressure), dry eyes, blood that clots easily, and inflamed blood vessels.
...
WebMD Health News Reviewed by [Neha Pathak, MD](https://www.webmd.com/neha-pathak-md) on January 29, 2021

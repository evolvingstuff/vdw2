{
    "title": "Increased visibility for VitaminDWiki pages",
    "slug": "increased-visibility-for-vitamindwiki-pages",
    "aliases": [
...
> see also [Off topic – Caregiving of seniors at home – helpful hints](/posts/off-topic-caregiving-of-seniors-at-home-helpful-hints)

* 3 hours scanning news items ~`100 new studies each day and uploading ~8 of them and updating 10 others
...
* [https://www.researchgate.net](https://www.researchgate.net) in PDF format

* [http://www.slideshare.net](http://www.slideshare.net) in PDF format

* [http://amazon.com](http://amazon.com) in Kindle format

* Social media such as [https://www.facebook.com](https://www.facebook.com),  [https://www.reddit.com](https://www.reddit.com)

> 1 paragraph intro with link to webpage

* Advertising of pages with Google AdWords 

> in many languages – English started in 2014

* Sending PDFs (with introductions)  to groups, such as

> [http://examine.com](http://examine.com),  [http://www.mercola.com](http://www.mercola.com),  [http://www.greenmedinfo.com](http://www.greenmedinfo.com) applicable forums
 ...
 **If you have suggestion of pages or locations for increased visibility please email - hlahore@gmail.com
...
> I may not have had enough time to extract it originally

* Edit for readability, possibly improve title
...
> Compare "Links to this page" at the bottom of the page with the outgoing hyperlinks

* Publish (make PDF, Kindle, . . ) - probably making "jacket covers" in each language

> Publish in English initially, then perhaps Spanish, etc.

> Note: Print to PDF at bottom of page is English-only.

People with a variety of talents will be needed to do the above preparation and publication** Would like to also create translatable versions of several graphics **The Text-based version of each graphic need not look the samen or have the same colors, but it should have similar content.
...
<img src="https://d1bk1kqxc0sym.cloudfront.net/attachments/jpeg/baggerly-58-000-for-pre-term-birth-nov-2013.jpg" alt="image">
...
<img src="/attachments/d3.mock.jpg" alt="image">** <span style="color:#00F;">VitaminDWiki uses software that allows many people to edit it at the same time.</span>__

Send me a note if you would like to help - hlahore@gmail.com

This page was created 11/11/2015 = singles day in China - [One Chinese company sold $14 billion online in one day](http://www.usatoday.com/story/tech/2015/11/11/chinas-e-commerce-company-alibaba-sells-record-143-billion-singles-day/75575434/)
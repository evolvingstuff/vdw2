{
    "title": "Risk of local Zika infections \u2013 model with global map",
    "slug": "risk-of-local-zika-infections-model-with-global-map",
    "aliases": [
        "/Risk+of+local+Zika+infections+\u2013+model+with+global+map+\u2013+April+2016",
        "/7732"
    ],
    "tiki_page_id": 7732,
    "date": "2016-08-07",
...
Kyeongah Nah1,2,3, Kenji Mizumoto1,3,4, Yuichiro Miyamatsu1,2,3, Yohei Yasuda1, Ryo Kinoshita1,2,3, Hiroshi Nishiura?1,2,3 nishiurah@gmail.com
 ...
 **Possibility of Zika infections by the end of 2016 is based on such factors as:** 

* Local Aedes mosquitoes (which carry Zika, Dengue, Chik.)

* Local Dengue virus 

* Local Chikungunya virus

* Airplane transportation

 **Model did not consider** 

* Zika without previous existing DENV and CHIKV

* 1. of passengers, only historical flight routes

* Additional trafic due to Rio Olympics

* Seasonal variations

* Variations within large countries such as United States, China and Australia

</div>

 **<i class="fas fa-file-pdf" style="margin-right: 0.3em;"></i><a href="https://d378j1rmrlek7x.cloudfront.net/attachments/pdf/importation-and-local-transmission-of-zika.pdf">Download the PDF from VitaminDWiki</a>** 

#### Risk of local Zika by end of 2016

<img src="https://d378j1rmrlek7x.cloudfront.net/attachments/jpeg/risk-of-local-zika.jpg" alt="image">

The origin country, Brazil, is colored in <span style="color:white;background-color:gray;">grey</span>

Other additional countries colored in <span style="color:white;background-color:gray;">grey</span> were excluded, because they experienced importation of ZIKV infection prior to the event in Brazil (week 12, 2015).

 **Comment by VitaminDWiki** 

 **It appears that <span style="color:white;background-color:gray;">grey</span> = 100% risk (countries already had local Zika - Canada, Norway?)** 

<img src="https://d378j1rmrlek7x.cloudfront.net/attachments/jpeg/risk-of-local-zika-bars.jpg" alt="image">

Bars filled with <span style="color:white;background-color:gray;">grey</span> represent countries that have already experienced importation of ZIKV infected case(s) by 31 January 2016

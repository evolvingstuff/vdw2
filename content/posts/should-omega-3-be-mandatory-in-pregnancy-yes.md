{
    "title": "Should Omega-3 be mandatory in Pregnancy (yes)",
    "slug": "should-omega-3-be-mandatory-in-pregnancy-yes",
    "aliases": [
...
by Mihaela Amza 1,2,3ORCID,Bashar Haj Hamoud 4,Romina-Marina Sima 1,2,*ORCID,Mihai-Daniel Dinu 3,Gabriel-Petre Gorecki 5ORCID,Mihai Popescu 6,7ORCID,Nicolae Gică 1,8ORCID,Mircea-Octavian Poenaru 1,2 and Liana Pleș 1,2

<img src="https://d378j1rmrlek7x.cloudfront.net/attachments/webp/recommend-o-3-in-prenancy.webp" alt="image" width="700">

<img src="https://d378j1rmrlek7x.cloudfront.net/attachments/webp/omege-3-pregnancy-rct.webp" alt="image" width="500">
 ...
 **<i class="fas fa-file-pdf" style="margin-right: 0.3em;"></i><a href="https://d378j1rmrlek7x.cloudfront.net/attachments/pdf/should-omega-3-be-manditory-when-pregnant-compresspdf.pdf">Download the PDF from VitaminDWiki </a>**
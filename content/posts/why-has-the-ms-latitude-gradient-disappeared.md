...
## If registered (free) <span>[tiki-download_file.php?fileId=2003]</span> for PDF  which had many graphs

- - - - - - 

## MS association with latitude has virtually been eliminated- [Lancet June 2010](https://www.VitaminDWiki.com/tiki-download_file.php?fileId=1188)
...
1. A tan is no longer a sign a beauty for women, so not outdoors as much

1. Increased use of sun-screen when outside - concerned about wrinkles and skin cancer

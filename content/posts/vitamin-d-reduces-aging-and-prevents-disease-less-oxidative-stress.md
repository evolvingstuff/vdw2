---
title: "Vitamin D reduces aging and prevents disease (less oxidative stress)"
...
1α(OH)ase homozygous null mice [1α(OH)ase−/−](1α(OH)ase−/−) in which the serum 1,25(OH)2D levels were undetectable and serum 25(OH)D levels were increased, develop hypocalcemia, hypophosphatemia and elevated parathyroid hormone (PTH) levels, when fed a normal diet, and survive on average for only 3 months (Chen et al., 2019). Increased tissue oxidative stress and DNA damage, downregulated Bmi1 and upregulated p16, p53 and p21 expression levels, reduced cell proliferation, and induced cell senescence and a . . . 
...
<!-- ~tc~ (alias(Vitamin D reduces aging and prevents disease (less oxidative sress) - Dec 2022)) ~/tc~ -->
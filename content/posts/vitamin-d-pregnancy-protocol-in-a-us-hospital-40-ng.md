{
    "title": "Vitamin D Pregnancy Protocol in a US hospital (40 ng)",
    "slug": "vitamin-d-pregnancy-protocol-in-a-us-hospital-40-ng",
    "aliases": [
        "/Vitamin+D+Pregnancy+Protocol+in+a+US+hospital+40+ng+\u2013+March+2016",
        "/7373"
    ],
    "tiki_page_id": 7373,
    "date": "2016-03-10",
 ...
 **[This is described at Grassroots Health](http://campaign.r20.constantcontact.com/render?m=1102200732336&ca=bdaaac40-a4ad-46fd-96d5-d9ea4fe68922)** 
...
1. A 25-0H Vitamin D level will be obtained routinely as part of the New OB prenatal blood work.

1. If the 25-0H Vitamin D level is < 40 ng/ml you can begin supplementation with 4000-5000 IU of Vitamin D per day.

1. More specific supplementation dosing can be achieved with the use of Figure 2. which provides a recommended daily dose of 25-0H Vitamin D based on the initial starting level and anticipating a goal of > 40 ng/ml.

1. Using the chart in Figure 2. to get 90% of the patients from an initial level of 20 ng/ml (many are even lower) to a level of 45 ng/ml, the likely required daily dose will be 5000 IU / day.

1. GrassrootsHealth through the Protect Our Children NOW! project has provided free Vitamin D (5000 IU capsules) for your patients that they can obtain by taking their prescription to the Rutledge Tower Pharmacy to have it filled.

1. The 25-0H Vitamin D level should be rechecked along with the routine Glucola screen at 24-28 weeks gestation. Vitamin D dosing adjustments can be made based on this mid-trimester measurement.

1. The 25-0H Vitamin D level should be checked a third time at 34-36 weeks gestation along with the third trimester CBC and / or STD blood work. A further dosage adjustment can be made at that time if required.

1. The 25-0H Vitamin D level is covered by insurance as part of the prenatal panel. Follow up testing is also covered if "Vitamin D Deficiency" is added to the problem list if the Vitamin D level is < 40 ng/ml.
...
<img src="https://d378j1rmrlek7x.cloudfront.net/attachments/jpeg/protocol-f1.jpg" alt="image">

#### Figure F2

<img src="https://d378j1rmrlek7x.cloudfront.net/attachments/jpeg/protocol-f2.jpg" alt="image" width="400">

 **(signed) Dr. Rodger Newman, Professor and Maas Endowed Chair of Reproductive Sciences** 

 **<i class="fas fa-file-pdf" style="margin-right: 0.3em;"></i><a href="https://d378j1rmrlek7x.cloudfront.net/attachments/pdf/musc-d-protocol.pdf">Download the Protocol PDF from VitaminDWiki</a>**
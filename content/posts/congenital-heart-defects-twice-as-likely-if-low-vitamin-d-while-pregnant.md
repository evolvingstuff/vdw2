{
    "title": "Congenital heart defects twice as likely if low vitamin D while pregnant",
    "slug": "congenital-heart-defects-twice-as-likely-if-low-vitamin-d-while-pregnant",
    "aliases": [
...
* [Congenital Heart Disease is associated with gestational diabetes in first trimester (need Vitamin D and Omega-3 early) Dec 2017](/posts/congenital-heart-disease-is-associated-with-gestational-diabetes-in-first-trimes-d-omega-3-early)

> CHD is increasing

> <img src="https://d1bk1kqxc0sym.cloudfront.net/attachments/jpeg/chd-prevelence.jpg" alt="image">

* [Preeclampsia increased risk of Congenital Heart Defects by 60 percent (vitamin D not mentioned) Oct 2015](/posts/preeclampsia-increased-risk-of-congenital-heart-defects-by-60-percent-vitamin-d-not-mentioned)
 ...
 **<i class="fas fa-file-pdf" style="margin-right: 0.3em;"></i><a href="https://d1bk1kqxc0sym.cloudfront.net/attachments/pdf/vit-d-chd-sci-hub.pdf">Download the Sci-Hub PDF via VitaminDWiki</a>** 
...
Case mothers less often had an adequate vitamin D status compared with controls (27% vs. 38%; p = 0.002). The use of multivitamin supplements, ethnicity, season and body mass index were associated with vitamin D concentrations. A moderate (odds ratio 1.58, <span>[95%CI 1.08, 2.32]</span>) and deficient (odds ratio  **2.15** , <span>[95%CI 1.44–3.19]</span>) vitamin D status were associated with CHD in offspring.

...
<a href="/posts/propensity-scores-are-useful-if-there-are-no-hidden-biases" style="color: red; text-decoration: underline;" title="This post/category does not exist yet: Propensity Scores are useful if there are no hidden biases">Propensity Scores are useful if there are no hidden biases</a>** 
...
{FONT(size="16")} **[<i class="fas fa-file-pdf" style="margin-right: 0.3em;"></i>Download the preprint PDF from VitaminDWiki](/attachments/d3.mock.pdf)** {FONT

---
title: "The Vitamin D receptor has been found in 54 human tissues"
...
Redox Biol . 2023 Jun;62:102695. [doi: 10.1016/j.redox.2023.102695](https://doi.org/10.1016/j.redox.2023.102695)
...
│   full_match: `\nRedox Biol . 2023 Jun;62:102695. `
│   inner_content: `\nRedox Biol . 2023 Jun;62:102695. `├── DoiLinkNode
│   full_match: `doi: 10.1016/j.redox.2023.102695`
│   inner_content: `10.1016/j.redox.2023.102695`├── TextNode
│   full_match: `\nCarsten Carlberg 1, Marianna Raczyk 2, Natalia Zawrotna 2\n\n`
│   inner_content: `\nCarsten Carlberg 1, Marianna Raczyk 2, Natalia Zawrotna 2\n\n`├── ImgNode
│   full_match: `{img type=&quot;attId&quot; attId=&quot;19567&quot; width=&quot;600&quot;}`
│   inner_content: ``
│   attrs_dict:
│   │   raw_content:  type=&quot;attId&quot; attId=&quot;19567&quot; width=&quot;600&quot;
│   │   type: attId
│   │   attId: 19567
│   │   width: 600├── TextNode
│   full_match: `\nNutrigenomics attempts to characterize and integrate the relation between dietary molecules and gene expression on a genome-wide level. One of the biologically active nutritional compounds is vitamin D3, which activates via its metabolite 1α,25-dihydroxyvitamin D3 (1,25(OH)2D3) the nuclear receptor VDR (vitamin D receptor). Vitamin D3 can be synthesized endogenously in our skin, but since we spend long times indoors and often live at higher latitudes where for many winter months UV-B radiation is too low, it became a true vitamin. The ligand-inducible transcription factor VDR is expressed in the majority of human tissues and cell types, where it modulates the epigenome at thousands of genomic sites. In a tissue-specific fashion this results in the up- and downregulation of primary vitamin D target genes, some of which are involved in attenuating oxidative stress. Vitamin D affects a wide range of physiological functions including the control of metabolism, bone formation and immunity. In this review, we will discuss how the epigenome- and transcriptome-wide effects of 1,25(OH)2D3 and its receptor VDR serve as a master example in nutrigenomics. In this context, we will outline the basis of a mechanistic understanding for personalized nutrition with vitamin D3.\n`
│   inner_content: `\nNutrigenomics attempts to characterize and integrate the relation between dietary molecules and gene expression on a genome-wide level. One of the biologically active nutritional compounds is vitamin D3, which activates via its metabolite 1α,25-dihydroxyvitamin D3 (1,25(OH)2D3) the nuclear receptor VDR (vitamin D receptor). Vitamin D3 can be synthesized endogenously in our skin, but since we spend long times indoors and often live at higher latitudes where for many winter months UV-B radiation is too low, it became a true vitamin. The ligand-inducible transcription factor VDR is expressed in the majority of human tissues and cell types, where it modulates the epigenome at thousands of genomic sites. In a tissue-specific fashion this results in the up- and downregulation of primary vitamin D target genes, some of which are involved in attenuating oxidative stress. Vitamin D affects a wide range of physiological functions including the control of metabolism, bone formation and immunity. In this review, we will discuss how the epigenome- and transcriptome-wide effects of 1,25(OH)2D3 and its receptor VDR serve as a master example in nutrigenomics. In this context, we will outline the basis of a mechanistic understanding for personalized nutrition with vitamin D3.\n`├── FontNode
│   full_match: `{FONT(size=&quot;18&quot;)}__{ATTACH(inline=&quot;1&quot; id=&quot;19566&quot; icon=&quot;1&quot;)}Download the PDF from VitaminDWiki {ATTACH}__{FONT}`
│   inner_content: `__{ATTACH(inline=&quot;1&quot; id=&quot;19566&quot; icon=&quot;1&quot;)}Download the PDF from VitaminDWiki {ATTACH}__`
│   attrs_dict:
│   │   raw_content: size=&quot;18&quot;
│   │   size: 18
│   children:
│   ├── BoldNode
│   │   full_match: `__{ATTACH(inline=&quot;1&quot; id=&quot;19566&quot; icon=&quot;1&quot;)}Download the PDF from VitaminDWiki {ATTACH}__`
│   │   inner_content: `{ATTACH(inline=&quot;1&quot; id=&quot;19566&quot; icon=&quot;1&quot;)}Download the PDF from VitaminDWiki {ATTACH}`
│   │   children:
│   │   ├── AttachNode
│   │   │   full_match: `{ATTACH(inline=&quot;1&quot; id=&quot;19566&quot; icon=&quot;1&quot;)}Download the PDF from VitaminDWiki {ATTACH}`
│   │   │   inner_content: `Download the PDF from VitaminDWiki `
│   │   │   attrs_dict:
│   │   │   │   raw_content: (inline=&quot;1&quot; id=&quot;19566&quot; icon=&quot;1&quot;)
│   │   │   │   inline: 1
│   │   │   │   id: 19566
│   │   │   │   icon: 1
│   │   │   children:
...
│   full_match: `\n---\n`
│   inner_content: `---`├── HeadingNode
│   full_match: `!!!!((A poor Vitamin D Receptor is associated with many cancers (oral cancer in this case) – Jan 2019|81+ Vitamin D Receptor and Cancer studies))`
│   inner_content: `((A poor Vitamin D Receptor is associated with many cancers (oral cancer in this case) – Jan 2019|81+ Vitamin D Receptor and Cancer studies))`
│   level: `4`
│   children:
│   ├── AliasedLocalLinkNode
│   │   full_match: `((A poor Vitamin D Receptor is associated with many cancers (oral cancer in this case) – Jan 2019|81+ Vitamin D Receptor and Cancer studies))`
...
│   │   ├── TextNode
│   │   │   full_match: `A poor Vitamin D Receptor is associated with many cancers (oral cancer in this case) – Jan 2019|81+ Vitamin D Receptor and Cancer studies`
│   │   │   inner_content: `A poor Vitamin D Receptor is associated with many cancers (oral cancer in this case) – Jan 2019|81+ Vitamin D Receptor and Cancer studies`├── TextNode
│   full_match: `\n`
│   inner_content: `\n`├── IncludeNode
...
{img type=&quot;attId&quot; attId=&quot;19567&quot; width=&quot;600&quot;}
Nutrigenomics attempts to characterize and integrate the relation between dietary molecules and gene expression on a genome-wide level. One of the biologically active nutritional compounds is vitamin D3, which activates via its metabolite 1α,25-dihydroxyvitamin D3 (1,25(OH)2D3) the nuclear receptor VDR (vitamin D receptor). Vitamin D3 can be synthesized endogenously in our skin, but since we spend long times indoors and often live at higher latitudes where for many winter months UV-B radiation is too low, it became a true vitamin. The ligand-inducible transcription factor VDR is expressed in the majority of human tissues and cell types, where it modulates the epigenome at thousands of genomic sites. In a tissue-specific fashion this results in the up- and downregulation of primary vitamin D target genes, some of which are involved in attenuating oxidative stress. Vitamin D affects a wide range of physiological functions including the control of metabolism, bone formation and immunity. In this review, we will discuss how the epigenome- and transcriptome-wide effects of 1,25(OH)2D3 and its receptor VDR serve as a master example in nutrigenomics. In this context, we will outline the basis of a mechanistic understanding for personalized nutrition with vitamin D3.
{FONT(size=&quot;18&quot;)}__{ATTACH(inline=&quot;1&quot; id=&quot;19566&quot; icon=&quot;1&quot;)}Download the PDF from VitaminDWiki {ATTACH}__{FONT}
---
...
---
!!!!((A poor Vitamin D Receptor is associated with many cancers (oral cancer in this case) – Jan 2019|81+ Vitamin D Receptor and Cancer studies))

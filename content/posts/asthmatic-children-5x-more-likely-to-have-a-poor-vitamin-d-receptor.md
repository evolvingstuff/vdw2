{
    "title": "Asthmatic children 5X more likely to have a poor Vitamin D Receptor",
...
**<span style="color:#F00;">Note: Unknown if Asthma ==>Poor VDR or if Poor VDR ==> Asthma</span>** 

 **Note: [Inhaling Vitamin D](/posts/inhaled-vitamin-d-help-lungs-many-studies) is looking promising for various breathing problems as of mid 2019** 

</div>

 **<i class="fas fa-file-pdf" style="margin-right: 0.3em;"></i><a href="https://d378j1rmrlek7x.cloudfront.net/attachments/pdf/vdr-asthma-sci-hub.pdf">Download the PDF from Sci-Hub via  VitaminDWiki</a>** 

<img src="https://d378j1rmrlek7x.cloudfront.net/attachments/jpeg/vdr-asthma-t2.jpg" alt="image" width="400">
...
* genotype (CC) of the TaqI polymorphism <span>[odds ratio __(OR) = 0.2__, 95% confidence interval (CI) (0.07–0.5), P = 0.003]</span> and 

* genotype (CA) of ApaI polymorphisms <span>[__OR = 0.2__, 95% CI (0.07–0.8), P = 0.02]</span>, and asthma risk. 

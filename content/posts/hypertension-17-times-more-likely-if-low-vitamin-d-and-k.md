{
    "title": "Hypertension 1.7 times more likely if low Vitamin D AND K",
    "slug": "hypertension-17-times-more-likely-if-low-vitamin-d-and-k",
    "aliases": [
        "/Hypertension+17+times+more+likely+if+low+Vitamin+D+AND+K+\u2013+Sept+2016",
        "/7821"
    ],
    "tiki_page_id": 7821,
    "date": "2016-09-20",
...
* [Vitamin D is good, but must balance Vitamins A and K2 to prevent Calcification – Masterjohn Aug 2014](/posts/vitamin-d-is-good-but-must-balance-vitamins-a-and-k2-to-prevent-calcification-masterjohn)

</div>

OBJECTIVE:

Vitamin D plays an important role in calcium homeostasis. The role of vitamin D in bone and cardiovascular health has mainly been studied in isolation and the synergistic effect of vitamin D and vitamin K is largely unknown. We assessed whether serum 25-hydroxyvitamin D <span>[25(OH)D]</span> levels and dephosphorylated, uncarboxylated matrix Gla protein (dp-unMGP) levels -an established marker of vitamin K status- are associated with incident hypertension among older adults in the Netherlands.

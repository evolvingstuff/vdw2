{
    "title": "Vitamin D3 and D2 had different associations",
    "slug": "vitamin-d3-and-d2-had-different-associations",
    "aliases": [
...
Context: Vitamin D status is believed to be best indicated by serum 25-hydroxyvitamin D <span>[25(OH)D; consisting of 25(OH)D3 and 25(OH)D2]</span> that are obtained from different sources. Suboptimal vitamin D status is common and associated with adverse health outcomes.
...
* [Overview D3 vs D2](/tags/overview-d3-vs-d2.html)

* [All items in category D3 vs D2](https://www.VitaminDWiki.com/tiki-browse_categories.php?parentId=51&sort_mode=created_desc) 40 items as Feb 2012
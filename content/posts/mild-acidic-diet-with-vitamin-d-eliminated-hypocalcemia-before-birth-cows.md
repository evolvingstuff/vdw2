{
    "title": "Mild acidic diet with vitamin D eliminated hypocalcemia before birth (cows)",
    "slug": "mild-acidic-diet-with-vitamin-d-eliminated-hypocalcemia-before-birth-cows",
    "aliases": [
...
J Dairy Sci. 2017 Dec 20. pii: S0022-0302(17)31191-8. [doi: 10.3168/jds.2017-13740.](https://doi.org/10.3168/jds.2017-13740.) <span>[Epub ahead of print]</span>

Martinez N1, Rodney RM2, Block E3, Hernandez LL4, Nelson CD1, Lean IJ2, Santos JEP5.

<div class="border" style="background-color:#FF9;padding:15px;margin:10px 0;border-radius:5px;width:600px">

Mild acidosis with Vitamin D: hypocalcemia 23 % ==> 0%

Using Calcidiol instead of Vitamin D also reduces 

* Placenta retention 30% ==> 3%

* Pelvic inflammatory disease 46% ==> 26%
...
* Vets give supplements by the pound of feed eaten (proportional to weight)

   * Humans are given supplements by the age of the person (not weight)

* Vets give 3X more vitamin D per pound as doctors

   * Vets are paid to heep their patients healthy, doctors are not

---

* [Overview Veterinary and vitamin D](/posts/overview-veterinary-and-vitamin-d)

* [Calcium and bone disorders in pregnancy – May 2012](/posts/calcium-and-bone-disorders-in-pregnancy) - includes hypcalcemia

#### See also web

* [Dietary cation-anion difference update](https://www.extension.umn.edu/agriculture/dairy/feed-and-nutrition/dietary-cation-anion-difference-update/) June 2007

* [The language of nutrition: DCAD (Dietary cation-anion difference)](https://www.progressivedairy.com/topics/feed-nutrition/the-language-of-nutrition-dcad-dietary-cation-anion-difference) March 2015

</div>

 **<i class="fas fa-file-pdf" style="margin-right: 0.3em;"></i><a href="https://d1bk1kqxc0sym.cloudfront.net/attachments/pdf/cows-health.pdf">Download the PDF from VitaminDWiki</a>** 
...
1. positive DCAD with cholecalciferol (PCH), 

1. positive DCAD with calcidiol (PCA), 

1. negative DCAD with cholecalciferol (NCH), and 

1. negative DCAD with calcidiol (NCA), 
...
* improved the proportion of neutrophils with oxidative burst activity (60.0 vs. 68.7%), 

* reduced the incidences of retained placenta (30.8 vs. 2.5%) and metritis (46.2 vs. 23.1%), and 

* reduced the proportion of cows with multiple diseases in early lactation. 
...
In conclusion, feeding prepartum cows with a diet containing a negative DCAD combined with 3 mg of calcidiol benefited health in early lactation.

PMID: 29274983 DOI: 10.3168/jds.2017-13740
...
second study by same authors in the same Journal issue

 **<i class="fas fa-file-pdf" style="margin-right: 0.3em;"></i><a href="https://d1bk1kqxc0sym.cloudfront.net/attachments/pdf/cows-mineral.pdf">Download the PDF from VitaminDWiki</a>** 

<img src="https://d1bk1kqxc0sym.cloudfront.net/attachments/jpeg/mineral.jpg" alt="image">
{
    "title": "Vitamin D level: 27 ng if low pollution, 12 ng if high pollution (Delhi children)",
    "slug": "vitamin-d-level-27-ng-if-low-pollution-12-ng-if-high-pollution-delhi-children",
    "aliases": [
...
* [Air Pollution reduces Vitamin D production - many studies](/posts/air-pollution-reduces-vitamin-d-production-many-studies) has the following reasons

1. Pollution reduces the amount of time that people are outdoors

1. Pollution attenuates the amount of UVB getting to the skin (by only a few percent)
 ...
 **<i class="fas fa-file-pdf" style="margin-right: 0.3em;"></i><a href="https://d378j1rmrlek7x.cloudfront.net/attachments/pdf/delhi-pollution.pdf">Download the PDF from VitaminDWiki</a>** 

<img src="https://d378j1rmrlek7x.cloudfront.net/attachments/jpeg/delhi-pollution.jpg" alt="image" width="700">
...
<!-- ~tc~ (alias(Vitamin D levels and pollution: 27 ng if low, only 12 ng if high (Delhi children) – June 2018)) ~/tc~ -->
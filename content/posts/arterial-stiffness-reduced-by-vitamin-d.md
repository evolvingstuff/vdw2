...
#### Arterial stiffness reduced by monthly 120,000 IU Vitamin D (overweight African-Americans) – RCT Dec 2017
...
PLoS One. 2017 Dec 7;12(12):e0188424. [doi: 10.1371/journal.pone.0188424.](https://doi.org/10.1371/journal.pone.0188424.) eCollection 2017.

Raed A1,2, Bhagatwala J1,2, Zhu H1,3, Pollock NK1,3, Parikh SJ1,2, Huang Y1, Havens R1, Kotak I1, Guo DH1, Dong Y1,3.

 **<i class="fas fa-file-pdf" style="margin-right: 0.3em;"></i><a href="https://d378j1rmrlek7x.cloudfront.net/attachments/pdf/arterial-stiffness-overweight-a-a.pdf">Download the PDF from VitaminDWiki</a>** 

<img src="https://d378j1rmrlek7x.cloudfront.net/attachments/jpeg/pwv-10-percent.jpg" alt="image" width="400">

 **[Report on this study at DoveMed](https://www.dovemed.com/current-medical-news/high-doses-vitamin-d-rapidly-reduce-arterial-stiffness-overweightobese-vitamin-deficient-african-americans/) Feb 2018** 
...
Br J Nutr. 2014 Sep 5:1-8. <span>[Epub ahead of print]</span>
 ...
 **[This study is described by the Vitamin C Council ](https://www.vitamindcouncil.org/blog/calcium-intake-associated-with-decreased-arterial-stiffness-only-in-those-with-higher-vitamin-d-intake/)- behind a $5/month paywall** 

 **[Publisher wants $45 for the PDF](http://journals.cambridge.org/action/displayAbstract?fromPage=online&aid=9344731&fileId=S0007114514002153)** 
...
* <span style="color:#F33;">reactive hyperemia</span> index (? = 0.23, p < 0.001), 

* pulse wave velocity (? = –0.09, p = 0.04), 

* augmentation index (? = –0.11, p = 0.03), and 

* <span style="color:#00F;">subendocardial viability ratio</span> (? = 0.18, p = 0.001). 

In 42 subjects with vitamin D insufficiency,  **normalization of 25-OH D at 6 months**  was associated with 

increases in 

* <span style="color:#F33;">reactive hyperemia</span> index (0.38 ± 0.14, p = 0.009) and 

* <span style="color:#00F;">subendocardial viability ratio</span> (7.7 ± 3.1, p = 0.04), and a 
...
J Hum Hypertens. 2011 Oct 20. [doi: 10.1038/jhh.2011.94.](https://doi.org/10.1038/jhh.2011.94.) 

{
    "title": "Familial Mediterranean Fever is associated with poor Vitamin D Binding Protein",
 ...
 **<i class="fas fa-file-pdf" style="margin-right: 0.3em;"></i><a href="https://d378j1rmrlek7x.cloudfront.net/attachments/pdf/med-fever-vdbp-sci-hub.pdf">Download the PDF from sci-hub via VitaminDWiki</a>** 
...
Results: We observed a statistically significant difference in the frequency of the 1F–2 genotype. The frequency of allele 2 was significantly higher and allele 1S was significantly lower compared to the <span>[MEFV(−)]</span> group and healthy controls (p = 0.034, 0.001, and 0.012, respectively). We observed a significant association between the presence of allele 2 and amyloidosis (p = 0.026) and arthritis (p = 0.044) in the <span>[MEFV(−)]</span> group.

Conclusion: Our results suggest that FMF symptoms in the absence of MEFV gene mutations may be due to the presence of VDBP allele 2. Therefore, VDBP genotype may explain the symptoms in FMF <span>[MEFV(−)]</span> patients.

---

#### Web

* [Familial Mediterranean fever](https://medlineplus.gov/genetics/condition/familial-mediterranean-fever/) Medline Plus 2020

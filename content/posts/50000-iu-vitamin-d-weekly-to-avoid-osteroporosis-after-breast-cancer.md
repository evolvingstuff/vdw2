{
    "title": "50,000 IU vitamin D weekly to avoid Osteroporosis after Breast Cancer",
...
:: **Note: Asked for the location of the equation Nov 25, 2020** ::
 ...
 **Study was trying to increase the Vitamin D levels after Breast Cancer so as to avoid developing osteoporosis** 
...
* [One pill every two weeks gives you all the vitamin D most adults need](/posts/one-pill-every-two-weeks-gives-you-all-the-vitamin-d-most-adults-need)
   ...
   * 50,000 IU every two weeks proven to prevent/treat 22 health problems

   * 50,000 IU weekly proven to treat an additional 17 health problems

</div>

 **<i class="fas fa-file-pdf" style="margin-right: 0.3em;"></i><a href="https://d1bk1kqxc0sym.cloudfront.net/attachments/pdf/practical-vitamin-d-supplementation-using-machine-learning-may-2020.pdf">Download the PDF from VitaminDWiki</a>** 

<img src="https://d1bk1kqxc0sym.cloudfront.net/attachments/jpeg/50-000-iu-weekly.jpg" alt="image" width="800">
...
As demonstrated in Table 2, several of the models had comparable strength. Because of the ease of interpretation of the impact of each variable, GLM was chosen. Table 3 looks at the breakdown of GLM. Variables with significant

Table 2. Root mean square estimate

RMSEa)	r cross validation13)	RMSE test setc)	r test setc)
...
Each model attempts to predict weekly vitamin D level changes based on treatment doses of vitamin D and various clinical and demographic features. A 20 fold cross validation with 5 repeated cycles was used to create the model from the training set. The hyperparameters of each model are adjusted to find the minimum RMSE. a)RMSE training set, which istheaverageoftheminimumRMSEforeachtrainingmodel.bPear- sons correlation between the observed and the computed weekly level changes. c)RMSE and R of the test set. Independent variables were age, body mass index, creatinine, and initial vitamin D level. Adjusted variables were race (white or non-white), endocrine therapy, and the different regimens. The training set to test set ratio was 4:1.
...
1. Sunyecz JA. The use of calcium and vitamin D in the management of osteoporosis. Ther Clin Risk Manag 2008;4: 827-36.

1. Hadji P, Aapro MS, Body JJ, et al. Management of aroma- tase inhibitor-associated bone loss (AIBL) in postmenopausal women with hormone sensitive breast cancer: Joint position statement of the IOF, CABS, ECTS, IEG, ESCEO IMS, and SIOG. J Bone Oncol 2017;7:1-12.

1. Makhoul I, Montgomery CO, Gaddy D, et al. The best of both worlds - managing the cancer, saving the bone. Nat Rev Endocrinol 2016;12:29-42.
...
1. Pepper KJ, Judd SE, Nanes MS, et al. Evaluation of vitamin D repletion regimens to correct vitamin D status in adults. Endocr Pract 2009;15:95-103.

1. Kimball SM, Ursell MR, O'Connor P, et al. Safety of vitamin D3 in adults with multiple sclerosis. Am J Clin Nutr 2007; 86:645-51.

1. Carmel AS, Shieh A, Bang H, et al. The 25(OH)D level needed to maintain a favorable bisphosphonate response is >/=33 ng/ml. Osteoporos Int 2012;23:2479-87.
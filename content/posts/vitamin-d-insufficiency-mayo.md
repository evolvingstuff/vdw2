{
    "title": "Vitamin D Insufficiency - Mayo",
    "slug": "vitamin-d-insufficiency-mayo",
    "aliases": [
        "/Vitamin+D+Insufficiency+-+Mayo+Jan+2011",
        "/2722"
    ],
    "tiki_page_id": 2722,
    "date": "2012-05-14",
...
Both forms of vitamin D undergo identical metabolism (Figure). Some evidence indicates that vitamin D2 may be metabolized more rapidly than vitamin D3,2,3 but with regular daily intake they can be considered bioequivalent.4,5 Both forms of vitamin D are converted to 25-hydroxyvitamin <span>[25(OH)D]</span> in the liver, and the serum level of 25(OH) D is measured to determine the adequacy of vitamin D status. In the kidney, 25(OH)D is hydroxylated to 1,25-dihydroxyvitamin D <span>[1,25(OH)2D]</span>, which is the only biologically active form of vitamin D. Acting principally on the duodenum, 1,25(OH)2D increases calcium absorption. It also acts on bone cells, both osteoblasts and osteoclasts, to mobilize calcium.
...
Did not have time to extract and cleanup the rest of the PDF

 **<span style="color:#00F;">PDF is attached at the bottom of this pager</span>**
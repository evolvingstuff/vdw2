{
    "title": "Language understanding by infant is associated with vitamin D level during pregnancy",
    "slug": "language-understanding-by-infant-is-associated-with-vitamin-d-level-during-pregnancy",
    "aliases": [
        "/Language+understanding+by+infant+is+associated+with+vitamin+D+level+during+pregnancy+\u2013+Dec+2015",
        "/7147"
    ],
    "tiki_page_id": 7147,
    "date": "2015-12-02",
...
neurocognitive development in some <sup>[14,16]</sup> but not all studies <span>[40–42]</span>. Our observations support

that language development is positively associated with gestational 25(OH)D levels as early as

2 years, while Whitehouse et al., showed an effect as late as age 7 <sup>[14]</sup>.
...
for each 1 IQ point decrease <sup>[44]</sup>.

 **<i class="fas fa-file-pdf" style="margin-right: 0.3em;"></i><a href="https://d378j1rmrlek7x.cloudfront.net/attachments/pdf/receptive-language-development.pdf">Download the PDF from VitaminDWiki</a>**
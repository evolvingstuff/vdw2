{
    "title": "Permethrin-dipped clothing kills Zika mosquitoes even after 10 washings",
    "slug": "permethrin-dipped-clothing-kills-zika-mosquitoes-even-after-10-washings",
    "aliases": [
...
Dipping clothing in permethrin – at factory or home.

Could not find a definition of mosquito knockdown

The study does not seem to address spraying Permehrin on clothing, just dipping

Machine washing does not remove permethrin as fast as handwashing

Note however: mosquitoes become immune to permethrin after a few years (e.g. Puerto rico) [CDC](/posts/zika-updates-from-cdc)

 **See also web** 

* [Wikipedia](https://en.wikipedia.org/wiki/Permethrin)

> . . " is toxic to fish and cats. In cats it may induce hyperexcitability, tremors, seizures, and death."
...
> "To better protect soldiers from the risk and annoyance of biting insects, the US and British armies are treating all new uniforms with permethrin."

* [Permethrin](http://npic.orst.edu/factsheets/PermGen.html) National Pesticide Information Center

* Sawyer (mfg of spray) - says it lasts 6 weeks or 6 washings.

* Apparently you can buy it concentrated and diulte to 0.5% for dipping clothing, etc.

* [Permethrin Treated Clothing](http://npic.orst.edu/pest/mosquito/ptc.html) National Pesticide Informatin Center, tips include
 ...
 **<i class="fas fa-file-pdf" style="margin-right: 0.3em;"></i><a href="https://d378j1rmrlek7x.cloudfront.net/attachments/pdf/permethrin-dipped-clothing-washing.pdf">Download the PDF from VitaminDWiki</a>** 

<img src="https://d378j1rmrlek7x.cloudfront.net/attachments/jpeg/factory-dipped.jpg" alt="image">

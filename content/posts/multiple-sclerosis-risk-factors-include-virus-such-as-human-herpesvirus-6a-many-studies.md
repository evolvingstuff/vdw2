...
&nbsp; &nbsp;Evidence linking HHV-6 with multiple sclerosis: an update- 2014 [<i class="fas fa-file-pdf" style="margin-right: 0.3em;"></i>PDF](/attachments/d3.mock.pdf)
...
<!-- ~tc~ (alias(Multiple Sclerosis Risk factors appear to include Human Herpesvirus 6A – Feb 2022)) ~/tc~ -->

<!-- ~tc~ (alias(Multiple Sclerosis Risk factors include virus such as Human Herpesvirus 6A – Feb 2022)) ~/tc~ -->